...
import { deleteCookie, getCookies, setCookie } from 'https://deno.land/std@0.142.0/http/cookie.ts';
export const Cookie = { get: getCookies, set: setCookie, delete: deleteCookie };
export { Status, STATUS_TEXT } from 'https://deno.land/std@0.142.0/http/http_status.ts';
